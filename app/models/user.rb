class User < ActiveRecord::Base
  ...
  attr_accessible :email, :password,:reseller_id,:reset_password_token,:client_id, :password_confirmation,:admin, :remember_me,:client_name,:balance,:balance_after_bet,:tier_id,
